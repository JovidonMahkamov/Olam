          ...
          child: SingleChildScrollView(
            child: Column(
              ...
              children: [
                ...
                _Label("Pachka (ixtiyoriy)"),
                const SizedBox(height: 6),
                _Field(controller: _pachkaCtrl, hint: "Masalan: 2", keyboardType: TextInputType.number, validator: _qtyValidator),

                const SizedBox(height: 10),
                _Label("Dona (ixtiyoriy)"),
                const SizedBox(height: 6),
                _Field(controller: _donaCtrl, hint: "Masalan: 2", keyboardType: TextInputType.number, validator: _qtyValidator),

                const SizedBox(height: 10),
                _Label("Metr (ixtiyoriy)"),
                const SizedBox(height: 6),
                _Field(controller: _metrCtrl, hint: "Masalan: 5", keyboardType: TextInputType.number, validator: _qtyValidator),
                ...
                const SizedBox(height: 14),
                _Label("Ishchi kiritadigan narxlar"),
                const SizedBox(height: 6),
                _Field(
                  controller: _sellPriceMetrCtrl,
                  hint: "Metr narx (ishchi) (tanlansa > 0)",
                ...
                _Field(
                  ...
                  hint: "Dona narx (ishchi) (tanlansa > 0)",
                  keyboardType: const TextInputType.numberWithOptions(decimal: true),
                  validator: _priceValidator,
                ),
                const SizedBox(height: 8),
                _Field(
                  ...
                  hint: "Pachka narx (ishchi) (tanlansa > 0)",
                  keyboardType: const TextInputType.numberWithOptions(decimal: true),
                  validator: _priceValidator,
                ),

                const SizedBox(height: 10),
                _Label("Summa (avtomatik)"),
                const SizedBox(height: 6),
